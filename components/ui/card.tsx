...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'border-border-subtle bg-card text-card-foreground flex flex-col gap-5 rounded-lg border py-5 shadow-none transition-[border-color,transform] duration-150 ease-[cubic-bezier(0.2,0,0,1)]',
        className,
      )}
      {...props}
    />
