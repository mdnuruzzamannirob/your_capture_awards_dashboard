  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          'bg-primary-soft text-primary-soft-foreground rounded-md data-[selected=true]:rounded-none',
